function sim_refit_thompson_3param_noveltybonus_parhor_MAP_HOLLY_all_uni(ID)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if holly == 1
        sim_dir = strcat('/home/mdubois/data/simulation_data/thompson/parhor_MAP/', int2str(n_per_dim), 'perdim_alluni/');
    else
        sim_dir = strcat('D:\MaggiesFarm\modeling_28_02\simulation_data\thompson\parhor_MAP\', int2str(n_per_dim), 'perdim_alluni\');
    end
    ...
    if holly == 1
        results_dir = strcat('/home/mdubois/data/simulation_data/thompson/parhor_MAP/', int2str(n_per_dim), 'perdim_alluni/results/');
    else
        results_dir = strcat('D:\MaggiesFarm\modeling_28_02\simulation_data\thompson\parhor_MAP\', int2str(n_per_dim), 'perdim_alluni\results\');
    end
...
%     end
    ...
    modelfun = @(x) modelMF_S0fixed_eta_2sgm0(x,settings.params.param_names,ID,settings,data,gameIDs);
    % modelfun = @(x) modelMF_S0fixed_eta_thomp4param_MAP_2sgm0_holly(x,settings.params.param_names,ID,settings,data,gameIDs);
    ...
    [mEmle, ~, ~] = modelfun(mEparams); %find likelihood 
