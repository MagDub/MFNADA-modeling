function sim_refit_UCB_3param_old(ID)
...
param_bounds_xi = [0.01,0.2]; % epsilon greedy
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if holly == 1
        sim_dir = strcat('/home/mdubois/data/simulation_data/UCB/3params/', int2str(n_per_dim), 'perdim/');
    else
        sim_dir = strcat('D:\MaggiesFarm\modeling_28_02\simulation_data\UCB\3params\', int2str(n_per_dim), 'perdim\');
    end
    ...
    if holly == 1
        results_dir = strcat('/home/mdubois/data/simulation_data/UCB/3params/', int2str(n_per_dim), 'perdim/results/');
    else
        results_dir = strcat('D:\MaggiesFarm\modeling_28_02\simulation_data\UCB\3params\', int2str(n_per_dim), 'perdim\results\');
    end
