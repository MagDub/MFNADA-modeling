...
%             end
            ...
            saving_dir = strcat('D:\MaggiesFarm\modeling_28_02\simulation_data\UCB\',int2str(n_param),'params\', int2str(n_per_dim), 'perdim', int2str(try_num),'\');
...
%                 int2str(param_bounds.tau(1)),'_',int2str(param_bounds.tau(2)),']\');
    ...
    elseif strcmp (algo, 'UCB_noveltybonus')
        ...
        if  n_param == 4
            ...
            saving_dir = strcat('D:\MaggiesFarm\modeling_28_02\simulation_data\UCB_noveltybonus\',int2str(n_param),'params\', int2str(n_per_dim), 'perdim\');
        end
    ...
    elseif strcmp (algo, 'hybrid')
        ...
        if n_param == 6
            ...
            saving_dir = strcat('D:\MaggiesFarm\modeling_28_02\simulation_data\hybrid\6params\', int2str(n_per_dim), 'perdim\');
        ...
        elseif n_param == 5
            ...
            saving_dir = strcat('D:\MaggiesFarm\modeling_28_02\simulation_data\hybrid\5params\', int2str(n_per_dim), 'perdim\');
        ...
        if n_param == 3
            ...
            saving_dir = strcat('D:\MaggiesFarm\modeling_28_02\simulation_data\UCBmean\',int2str(n_param),'params\', int2str(n_per_dim), 'perdim\');
...
%                 int2str(param_bounds.tau(1)),'_',int2str(param_bounds.tau(2)),']\');
        ...
        if n_param == 3
            ...
            saving_dir = strcat('D:\MaggiesFarm\modeling_28_02\simulation_data\UCBargmax\',int2str(n_param),'params\', int2str(n_per_dim), 'perdim\');
        end
