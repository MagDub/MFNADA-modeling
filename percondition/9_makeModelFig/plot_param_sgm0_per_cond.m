...
function [] = plot_param_sgm0_per_cond(cond)
    ...
    ind_SH = find(contains(model_parameters_desc,'sgm0_short'));
    ind_LH = find(contains(model_parameters_desc,'sgm0_long'));
    param_SH = model_parameters(:,ind_SH);
    param_LH = model_parameters(:,ind_LH);
    
    param_sgm0_SH = param_SH;
    param_sgm0_LH = param_LH;
        
    save(strcat('./params/param_sgm0_', cond, '_SH.mat'), 'param_sgm0_SH');
    save(strcat('./params/param_sgm0_', cond, '_LH.mat'), 'param_sgm0_LH');
    ...
    % Export
    addpath('../../../export_fig')
    export_fig(['./fig/Fig_param_sgm0_',cond,'.tif'],'-nocrop','-r200')
