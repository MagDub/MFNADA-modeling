function fit_hybrid_5param_noveltybonus_2Hor_1tau1w(ID, optim_algo)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if holly == 1
        results_dir = strcat('/home/mdubois/data/participant_data/',algo,'/',int2str(n_param), 'params_2Hor_1tau1w/results/', optim_algo,'/');
    else
        results_dir = strcat('D:\MaggiesFarm\modeling_28_02\participant_data\',algo,'\', int2str(n_param), 'params_2Hor_1tau1w\results\',optim_algo,'\');
    end
    ...
    settings.params.ub          = [param_bounds_gamma(2) param_bounds_gamma(2) param_bounds_tau(2) param_bounds_xi(2) param_bounds_xi(2)  param_bounds_sgm0(2)  param_bounds_eta(1) param_bounds_w_hyb(2)];    % upper bound
