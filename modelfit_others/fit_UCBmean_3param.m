function fit_UCBmean_3param(ID, optim_algo)
 
holly = 0;

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
param_bounds_gamma = [10^-4,20]; % information bonus
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    settings.desc = ['UCBmean'];    % description of model (settings, etc)
