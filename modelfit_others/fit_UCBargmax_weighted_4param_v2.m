function fit_UCBargmax_weighted_4param_v2(ID, optim_algo)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    settings.funs.learningfun   = @argmax_v2_weighted;
    settings.desc = ['UCBargmaxweightedv2'];    % description of model (settings, etc)
