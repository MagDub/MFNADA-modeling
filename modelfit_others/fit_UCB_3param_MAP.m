function fit_UCB_3param_MAP(ID, optim_algo)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    modelfun = @(x) modelMF_S0fixed_Q0fixed_sgm0fixed_lapse_MAP(x,settings.params.param_names,ID,settings,data,gameIDs);  
