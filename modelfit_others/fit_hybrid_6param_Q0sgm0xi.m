function fit_hybrid_6param_Q0sgm0xi(ID, optim_algo)

holly = 0;

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
param_bounds_gamma = [0,5]; % information bonus
param_bounds_tau = [10^-8,4]; % inverse temperature
param_bounds_xi = [0,0.2];  % epsilon greedy
param_bounds_sgm0 = [1,10];
param_bounds_w_hyb = [0,1]; % arbitrates between thompson and UCB
param_bounds_Q0 = [2,10]; 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    
    algo = 'hybrid_Q0sgm0xi';
    n_param = 6;
    ...
    settings.params.lb          = [param_bounds_gamma(1)  param_bounds_gamma(1)  param_bounds_tau(1) param_bounds_tau(1) param_bounds_xi(1) param_bounds_sgm0(1)   param_bounds_Q0(1)  param_bounds_w_hyb(1) param_bounds_w_hyb(1)];    % lower bound
    settings.params.ub          = [param_bounds_gamma(2)  param_bounds_gamma(2)  param_bounds_tau(2) param_bounds_tau(2) param_bounds_xi(2) param_bounds_sgm0(2)   param_bounds_Q0(2)  param_bounds_w_hyb(2) param_bounds_w_hyb(2)];    % upper bound
