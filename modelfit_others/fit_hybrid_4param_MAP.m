function fit_hybrid_4param_MAP(ID, optim_algo)
...
%   
    ...
    modelfunLL = @(x) modelMF_S0fixed_Q0fixed(x,settings.params.param_names,ID,settings,data,gameIDs);
    modelfun = @(x) modelMF_S0fixed_Q0fixed_MAP(x,settings.params.param_names,ID,settings,data,gameIDs);
