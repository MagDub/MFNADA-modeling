function fit_UCB_4param_v2(ID, optim_algo)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    settings.params.param_names = {'gamma'   ''         'tau'      ''    'xi'  '' 'Q0'};   % is same param name as prev, write ''
    settings.params.lb          = [param_bounds_gamma(1)   param_bounds_gamma(1) param_bounds_tau(1) param_bounds_tau(1) param_bounds_xi(1) param_bounds_xi(1) param_bounds_Q0(1)];    % lower bound
    settings.params.ub          = [param_bounds_gamma(2)   param_bounds_gamma(2) param_bounds_tau(2) param_bounds_tau(2) param_bounds_xi(2) param_bounds_xi(2) param_bounds_Q0(2)];    % upper bound
    ...
    modelfun = @(x) modelMF_S0fixed_sgm0fixed_lapse(x,settings.params.param_names,ID,settings,data,gameIDs);   
