function fit_hybrid_5param_MAP(ID, optim_algo)
...
%   
    ...
    modelfunLL = @(x) modelMF_S0fixed_Q0fixed_lapse(x,settings.params.param_names,ID,settings,data,gameIDs);
    modelfun = @(x) modelMF_S0fixed_Q0fixed_lapse_MAP(x,settings.params.param_names,ID,settings,data,gameIDs);
