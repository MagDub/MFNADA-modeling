function fit_UCBargmin_3param(ID, optim_algo)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    settings.funs.learningfun   = @argmin;
    settings.desc = ['UCBargmin'];    % description of model (settings, etc)
    ...
    modelfun = @(x) modelMF_S0fixed_Q0fixed_sgm0fixed_lapse_argmin(x,settings.params.param_names,ID,settings,data,gameIDs);   
