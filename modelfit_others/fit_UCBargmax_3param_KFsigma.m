function fit_UCBargmax_3param_KFsigma(ID, optim_algo)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    settings.funs.learningfun   = @kalman_filt_sgm_mean_argmax;
    ...
    modelfun = @(x) modelMF_S0fixed_Q0fixed_sgm0fixed_lapse_argmax(x,settings.params.param_names,ID,settings,data,gameIDs);   
