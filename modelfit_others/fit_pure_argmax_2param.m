function fit_pure_argmax_2param(ID, optim_algo)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    settings.funs.valuefun      = @pure_argmax; 
    settings.funs.priorfun      = [];
    settings.funs.learningfun   = @argmax_no_sgm;
    settings.desc = ['pure_argmax'];    % description of model (settings, etc)
    settings.params.param_names = {'tau'      ''    'xi'  ''};   % is same param name as prev, write ''
    settings.params.lb          = [param_bounds_tau(1) param_bounds_tau(1) param_bounds_xi(1) param_bounds_xi(1)];    % lower bound
    settings.params.ub          = [param_bounds_tau(2) param_bounds_tau(2) param_bounds_xi(2) param_bounds_xi(2)];    % upper bound
