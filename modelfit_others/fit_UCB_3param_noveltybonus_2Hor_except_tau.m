function fit_UCB_3param_noveltybonus_2Hor_except_tau(ID, optim_algo)
 
holly = 0;

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
param_bounds_gamma = [10^-8,10]; % information bonus
param_bounds_tau = [10^-8,2]; % inverse temperature
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if holly == 1
        results_dir = strcat('/home/mdubois/data/participant_data/',algo,'/',int2str(n_param), 'params_2Hor_excepttau/results/', optim_algo,'/');
    else
        results_dir = strcat('D:\MaggiesFarm\modeling_28_02\participant_data\',algo,'\', int2str(n_param), 'params_2Hor_excepttau\results\',optim_algo,'\');
    end
...
%         toc
    ...
    % save
    save_func_data(ID, settings, results_dir, mEparams, mEmle,[], mEexitflag, mEsubj, [], HeY, mEmatparams, mEmatmle)
