function fit_UCB_5param_noveltybonus(ID, optim_algo)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    settings.params.param_names = {'gamma'   ''         'tau'      ''    'xi'  '' 'sgm0' '' 'Q0' 'eta'};   % is same param name as prev, write ''
    settings.params.lb          = [param_bounds_gamma(1)   param_bounds_gamma(1) param_bounds_tau(1) param_bounds_tau(1) param_bounds_xi(1) param_bounds_xi(1) param_bounds_sgm0(1) param_bounds_sgm0(1) param_bounds_Q0(1) param_bounds_eta(1)];    % lower bound
    settings.params.ub          = [param_bounds_gamma(2)   param_bounds_gamma(2) param_bounds_tau(2) param_bounds_tau(2) param_bounds_xi(2) param_bounds_xi(2) param_bounds_sgm0(2) param_bounds_sgm0(2) param_bounds_Q0(2) param_bounds_eta(2)];    % upper bound
    ...
    modelfun = @(x) modelMF_S0fixed_noveltybonus(x,settings.params.param_names,ID,settings,data,gameIDs);   
