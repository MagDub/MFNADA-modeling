function fit_UCB_3param_hor11(ID, optim_algo)
...
param_bounds_xi = [0,0.5]; % epsilon greedy
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if holly == 1
        results_dir = strcat('/home/mdubois/data/participant_data/',algo,'/',int2str(n_param), 'params/results/hor11/', optim_algo,'/');
    else
        results_dir = strcat('D:\MaggiesFarm\modeling_28_02\participant_data\',algo,'\', int2str(n_param), 'params\results\hor11\',optim_algo,'\');
    end
