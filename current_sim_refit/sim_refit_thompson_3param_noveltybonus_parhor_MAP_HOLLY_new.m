...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    sim_dir = strcat('/home/mdubois/data/simulation_data/thompson/parhor_MAP/', int2str(n_per_dim), 'perdim_newbounds/');
    ...
    results_dir = strcat('/home/mdubois/data/simulation_data/thompson/parhor_MAP/', int2str(n_per_dim), 'perdim_newbounds/results/');
