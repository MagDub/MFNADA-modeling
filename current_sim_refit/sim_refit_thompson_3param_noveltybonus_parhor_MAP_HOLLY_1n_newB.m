function sim_refit_thompson_3param_noveltybonus_parhor_MAP_HOLLY_1n_newB(ID)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if holly == 1
        sim_dir = strcat('/home/mdubois/data/simulation_data/thompson/parhor_MAP/', int2str(n_per_dim), 'perdim_newbounds_sgm0_1Q0/');
    else
        sim_dir = strcat('D:\MaggiesFarm\modeling_28_02\simulation_data\thompson\parhor_MAP\', int2str(n_per_dim), 'perdim_newbounds_sgm0_1Q0\');
    end
    ...
    if holly == 1
        results_dir = strcat('/home/mdubois/data/simulation_data/thompson/parhor_MAP/', int2str(n_per_dim), 'perdim_newbounds_sgm0_1Q0/results/');
    else
        results_dir = strcat('D:\MaggiesFarm\modeling_28_02\simulation_data\thompson\parhor_MAP\', int2str(n_per_dim), 'perdim_newbounds_sgm0_1Q0\results\');
    end
