function sim_refit_Thompson_3param(ID)

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
holly = 1;
n_per_dim = 20;
param_bounds_xi = [0.01,0.5];
param_bounds_sgm0 = [0.5,3]; 
param_bounds_Q0 = [2,9]; 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if holly == 1
        sim_dir = strcat('/home/mdubois/data/simulation_data/thompson/3params/', int2str(n_per_dim), 'perdim/');
    else
        sim_dir = strcat('D:\MaggiesFarm\modeling_28_02\simulation_data\thompson\3params\', int2str(n_per_dim), 'perdim\');
    end
    ...
    if holly == 1
        results_dir = strcat('/home/mdubois/data/simulation_data/thompson/3params/', int2str(n_per_dim), 'perdim/results/');
    else
        results_dir = strcat('D:\MaggiesFarm\modeling_28_02\simulation_data\thompson\3params\', int2str(n_per_dim), 'perdim\results\');
    end
