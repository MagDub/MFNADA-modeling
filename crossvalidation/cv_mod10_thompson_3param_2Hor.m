function cv_mod10_thompson_3param_2Hor(ID)
    ...
    for k = 1:Kf
        ...
        if holly == 1
            ...
            results_dir = strcat('D:\MaggiesFarm\modeling_28_02\participant_data\k',int2str(Kf),'\',algo,'\', int2str(n_param), 'params_2Hor_Q01_2sgm0\results\');
        end
