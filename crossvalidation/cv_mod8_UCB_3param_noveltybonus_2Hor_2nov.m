function cv_mod8_UCB_3param_noveltybonus_2Hor_2nov(ID)
    ...
    for k = 1:Kf
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            ...
            if holly == 1
                ...
                results_dir = strcat('D:\MaggiesFarm\modeling_28_02\participant_data\k',int2str(Kf),'\',algo,'\', int2str(n_param), 'params_2Hor\results\');
            end
