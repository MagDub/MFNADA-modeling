...
%%%%%
model = model+1;
mod.file_name{model} = 'D:\MaggiesFarm\modeling_28_02\participant_data\crossval_thompson_noveltybonus_2nov\3params_2Hor_2Q01_2sgm0\results\aver_prob_';
mod.model_type{model} = 'thompson';
mod.name{model} = 'thompson3params2Hor2nov2Q012s';
mod.legend{model} = 'thompsonnov(2sgm0,2Q01)+nov(2)+xi(2)';
