...
%%%%%%%%%%
model = model+1;
mod.file_name{model} = 'D:\MaggiesFarm\modeling_28_02\participant_data\k10\crossval_hybrid\4params_2Hor_1w\results\aver_prob_';
mod.model_type{model} = 'hybrid';
mod.name{model} = 'hybrid4params2Hor1w';
mod.legend{model} = 'hybrid(2g,2t,1w,2sgm0)';
%%%%%%
model = model+1;
mod.file_name{model} = 'D:\MaggiesFarm\modeling_28_02\participant_data\k10\crossval_hybrid\5params_2Hor_1w\results\aver_prob_';
mod.model_type{model} = 'hybrid';
mod.name{model} = 'hybrid5params2Hor1w';
mod.legend{model} = 'hybrid(2g,2t,1w,2sgm0)+xi(2)';
%%%%%
model = model+1;
mod.file_name{model} = 'D:\MaggiesFarm\modeling_28_02\participant_data\k10\crossval_hybrid_noveltybonus_both\4params_2Hor_1w_2eta\results\aver_prob_';
mod.model_type{model} = 'hybrid';
mod.name{model} = 'hybridnovboth4params2Hor1w';
mod.legend{model} = 'hybrid(2g,2t,1w,2sgm0)+nov(2)'; 
%%%%%
model = model+1;
mod.file_name{model} = 'D:\MaggiesFarm\modeling_28_02\participant_data\k10\crossval_hybrid_noveltybonus_both_2nov\5params_2Hor_1w\results\aver_prob_';
mod.model_type{model} = 'hybrid';
mod.name{model} = 'hybridnovboth4paramsxi2Hor2nov';
mod.legend{model} = 'hybrid(2g,2t,1w,2sgm0)+nov(2)+xi(2)'; 
%%%%%%%
% UCB %
%%%%%%%
model = model+1;
