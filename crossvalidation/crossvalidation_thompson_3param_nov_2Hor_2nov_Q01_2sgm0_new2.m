function crossvalidation_thompson_3param_nov_2Hor_2nov_Q01_2sgm0_new2(ID)

    % modelMF dans test etait faux dans _new !!!

    trials_trained_on = 180;
    ...
    for k = 1:10
        ...
        if holly == 1
            results_dir = strcat('/home/mdubois/data/participant_data/',algo,'/',int2str(n_param), 'params_2Hor_Q01_2sgm0_new/results/');
        else
            results_dir = strcat('D:\MaggiesFarm\modeling_28_02\participant_data\',algo,'\', int2str(n_param), 'params_2Hor_Q01_2sgm0_new\results\');
        end
        ...
        [test_nLogL, ~, ~] = modelMF_S0fixed_crossval_eta_2sgm0(mEparams,settings.params.param_names,ID,settings,data_test,gameIDs_test, 1, 20);
