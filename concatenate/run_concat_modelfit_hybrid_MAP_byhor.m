...
[all_parameters_hybrid] = concatenate_all_params_hybrid_MAP_byhor(num_part);
...
xi_mat_hybrid_short = [all_parameters_hybrid(:,5)];
xi_mat_hybrid_long = [all_parameters_hybrid(:,6)];
xi_mat_hybrid = [xi_mat_hybrid_short xi_mat_hybrid_long];
sgm0_mat_hybrid = [all_parameters_hybrid(:,7)];
w_mat_hybrid_short = [all_parameters_hybrid(:,8)];
w_mat_hybrid_long = [all_parameters_hybrid(:,9)];
...
hist(w_mat_hybrid, 10, 'Normalization', 'pdf');
legend('Short Horizon', 'Long Horizon')
title('hybrid - w')
