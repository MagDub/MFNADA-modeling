...
[all_parameters_thomp_noveltybonus_MAP] = concatenate_all_params_thomp_nov_2Hor_1nov_Q01_MAP_uni_2s();
...
eta_mat_thomp = [all_parameters_thomp_noveltybonus_MAP(:,6)];


model_parameters = [all_parameters_thomp_noveltybonus_MAP];
model_parameters_desc = [{'sgm0_short'} {'sgm0_long'} {'Q0'} {'xi_short'} {'xi_long'} {'eta'}];

save('D:\writing\MF_dev\data_for_figs\model_parameters_1n_2s.mat', 'model_parameters');
save('D:\writing\MF_dev\data_for_figs\model_parameters_1n_2s_desc.mat', 'model_parameters_desc');
