...
[all_parameters_thomp_noveltybonus] = concatenate_all_params_thomp_noveltybonus_2Hor(num_part);

sgm0_mat_UCB = [all_parameters_thomp_noveltybonus(:,1)];
Q0_mat_UCB = [all_parameters_thomp_noveltybonus(:,2)];
xi_mat_UCB_short = [all_parameters_UCB_noveltybonus(:,3)];
xi_mat_UCB_long = [all_parameters_UCB_noveltybonus(:,4)];
xi_mat_UCB = [xi_mat_UCB_short xi_mat_UCB_long];
eta_mat_UCB = [all_parameters_thomp_noveltybonus(:,5)];
