...
[all_parameters_UCB_noveltybonus] = concatenate_all_params_UCB_noveltybonus_byhor_2Hor(num_part);
...
tau_mat_UCB_short = [all_parameters_UCB_noveltybonus(:,3)];
tau_mat_UCB_long = [all_parameters_UCB_noveltybonus(:,4)];
tau_mat_UCB = [tau_mat_UCB_short tau_mat_UCB_long];
xi_mat_UCB_short = [all_parameters_UCB_noveltybonus(:,5)];
xi_mat_UCB_long = [all_parameters_UCB_noveltybonus(:,6)];
xi_mat_UCB = [xi_mat_UCB_short xi_mat_UCB_long];
eta_mat_UCB = [all_parameters_UCB_noveltybonus(:,7)];
