...
[all_parameters_UCB_noveltybonus] = concatenate_all_params_UCB_noveltybonus_byhor_xi1Hor_tau1Hor(num_part);
...
xi_mat_UCB = [all_parameters_UCB_noveltybonus(:,4)];
eta_mat_UCB = [all_parameters_UCB_noveltybonus(:,5)];
