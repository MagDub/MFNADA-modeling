...
consistency_freq_simulation_mod12_ACD = nan(60,2);
...
for ID = 501:560
    ...
    load(strcat('D:\MaggiesFarm\modeling_28_02\simulation_data\simulated_data_from_fitted_params_mod12_ACD\num_trials_',int2str(num_trials),'\participant_',int2str(ID),'\data.mat'))
    ...
    consistency_freq_simulation_mod12_ACD(ID-500,:) = [consistency_freq_simulation_LH consistency_freq_simulation_SH];
end

consistency_freq_simulation_mod12_desc_mod12_ACD = {'LH_Consistent','SH_Consistent'};

save('D:\writing\MF\data_for_figs\consist_per_cond\consistency_freq_simulation_mod12_ACD.mat', 'consistency_freq_simulation_mod12_ACD');
save('D:\writing\MF\data_for_figs\consist_per_cond\consistency_freq_simulation_mod12_desc_mod12_ACD.mat', 'consistency_freq_simulation_mod12_desc_mod12_ACD');
