...
sim_folder = strcat('D:\writing\MF\data_for_figs\sim_prob_mod12_changing_eta_BCD\sgm0_',num2str(sgm0_mat),'_Q0_',num2str(Q0_mat),'_xi_',num2str(xi_mat),'\');
...
for eta_iter = 1:size(eta_range,2)
    ...
    for c = 1:settings.task.N_hor
        ...
        [sim_consistency_freq, sim_consistency_freq_desc] = make_consistency_from_sim_percond_BCD(sim_data_dir);
