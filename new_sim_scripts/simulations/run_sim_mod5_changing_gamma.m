...
function [] = run_sim_mod5_changing_gamma(tau, Q0, gamma_range)

    part_num = 200;

    sim_folder = strcat('../../../data/simulation_data/sim_prob_mod5/changing_gamma/tau_',num2str(tau),'_Q0_',num2str(Q0),'/');
    ...
    for gamma_iter = 1:size(gamma_range,2)
        ...
        para_vals_desc = {'tau', 'Q0', 'gamma'};

        para_vals = [tau, Q0, gamma]; 
