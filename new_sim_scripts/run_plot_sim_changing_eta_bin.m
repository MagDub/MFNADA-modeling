...
sim_folder = strcat('D:\writing\MF\data_for_figs\sim_prob_mod12_changing_eta\sgm0_',num2str(sgm0_mat),'_Q0_',num2str(Q0_mat),'_xi_',num2str(xi_mat),'\');
...
for eta_iter = 1:size(eta_range,2)
    ...
    for ID = 1:part_num
        ...
        mat_trees_bandits(ID,:) = tmp_trees_bandits.sim_prob_choosing_trees_new_data*100; % A_SH, B_SH, C_SH, D_SH, A_LH, B_LH, C_LH, D_LH
