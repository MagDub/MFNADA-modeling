function HOLLY_cv_mod19(ID, data_fol)
    ...
    for k = 1:Kf
        ...
        algo = 'mod_19'; % V=0 for all -> softmax       
        ...
        settings.desc                   = ['mod19'];    
        settings.params.param_names     = {'Q0'   'eta'   '' 'tau' ''};   
        settings.params.lb              = [param_bounds_Q0(1)  param_bounds_eta(1) param_bounds_eta(1) param_bounds_tau(1) param_bounds_tau(1)];    
        settings.params.ub              = [param_bounds_Q0(2)  param_bounds_eta(2) param_bounds_eta(2) param_bounds_tau(2) param_bounds_tau(2)];       
