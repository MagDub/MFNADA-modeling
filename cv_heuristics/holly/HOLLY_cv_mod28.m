function HOLLY_cv_mod28(ID, data_fol)
    ...
    for k = 1:Kf
        ...
        settings.desc                   = ['mod28'];    
        settings.params.param_names     = {'gamma', '', 'Q0', 'eta', '', 'xi', ''};   
        settings.params.lb              = [param_bounds_gamma(1)   param_bounds_gamma(1) param_bounds_Q0(1) param_bounds_eta(1) param_bounds_eta(1) param_bounds_xi(1) param_bounds_xi(1)];    % lower bound
        settings.params.ub              = [param_bounds_gamma(2)   param_bounds_gamma(2) param_bounds_Q0(2) param_bounds_eta(2) param_bounds_eta(2) param_bounds_xi(2) param_bounds_xi(2)];    % upper bound
