...
gamma_1_SH = tmp_SH.mat_mean_SEM_tree_low(2,1);
gamma_2_SH = tmp_SH.mat_mean_SEM_tree_low(5,1);

ind_1_SH = find(tmp_SH.mat_mean_SEM_tree_low(:,1)==gamma_1_SH);
ind_2_SH = find(tmp_SH.mat_mean_SEM_tree_low(:,1)==gamma_2_SH);
...
gamma_1_LH = tmp_LH.mat_mean_SEM_tree_low(4,1);
gamma_2_LH = tmp_LH.mat_mean_SEM_tree_low(8,1);

ind_1_LH = find(tmp_LH.mat_mean_SEM_tree_low(:,1)==gamma_1_LH);
ind_2_LH = find(tmp_LH.mat_mean_SEM_tree_low(:,1)==gamma_2_LH);
...
addpath('../../../export_fig/')
export_fig('Fig_mod5_low_gamma.tif','-nocrop','-r200')
