...
sgm0_1_SH = tmp_SH.mat_mean_SEM_consistency(1,1);
sgm0_2_SH = tmp_SH.mat_mean_SEM_consistency(3,1);

ind_1_SH = find(tmp_SH.mat_mean_SEM_consistency(:,1)==sgm0_1_SH);
ind_2_SH = find(tmp_SH.mat_mean_SEM_consistency(:,1)==sgm0_2_SH);
...
sgm0_1_LH = tmp_SH.mat_mean_SEM_consistency(2,1);
sgm0_2_LH = tmp_SH.mat_mean_SEM_consistency(4,1);

ind_1_LH = find(tmp_LH.mat_mean_SEM_consistency(:,1)==sgm0_1_LH);
ind_2_LH = find(tmp_LH.mat_mean_SEM_consistency(:,1)==sgm0_2_LH);
...
addpath('../../../export_fig/')
export_fig('Fig_mod12_consist_sgm0.tif','-nocrop','-r200')
