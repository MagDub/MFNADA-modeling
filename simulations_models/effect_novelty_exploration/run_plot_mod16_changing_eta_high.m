...
ind_1_SH = find(tmp_SH.mat_mean_SEM_tree_high(:,1)==eta_1_SH);
ind_2_SH = find(tmp_SH.mat_mean_SEM_tree_high(:,1)==eta_2_SH);
...
ind_1_LH = find(tmp_LH.mat_mean_SEM_tree_high(:,1)==eta_1_LH);
ind_2_LH = find(tmp_LH.mat_mean_SEM_tree_high(:,1)==eta_2_LH);
...
addpath('../../../export_fig/')
export_fig('Fig_argmax_high_eta.tif','-nocrop','-r200')
