...
xi_1_SH = tmp_SH.mat_mean_SEM_consistency(2,1);
xi_2_SH = tmp_SH.mat_mean_SEM_consistency(4,1);

ind_1_SH = find(tmp_SH.mat_mean_SEM_consistency(:,1)==xi_1_SH);
ind_2_SH = find(tmp_SH.mat_mean_SEM_consistency(:,1)==xi_2_SH);
...
xi_1_LH = tmp_LH.mat_mean_SEM_consistency(3,1);
xi_2_LH = tmp_LH.mat_mean_SEM_consistency(5,1);

ind_1_LH = find(tmp_LH.mat_mean_SEM_consistency(:,1)==xi_1_LH);
ind_2_LH = find(tmp_LH.mat_mean_SEM_consistency(:,1)==xi_2_LH);
