...
dec_num_1 = mat_mean_SEM_tree_high(3,1);
dec_num_2 = mat_mean_SEM_tree_high(7,1);

gamma_1 = dec_num_1;
gamma_2 = dec_num_2;

ind_1 = find(mat_mean_SEM_tree_high(:,1)==gamma_1);
ind_2 = find(mat_mean_SEM_tree_high(:,1)==gamma_2);
...
addpath('../../export_fig/')
export_fig('Fig_UCB_high_gamma.tif','-nocrop','-r200')
