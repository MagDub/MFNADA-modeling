...
ind_1 = find(mat_mean_SEM_tree_high(:,1)==eta_1);
ind_2 = find(mat_mean_SEM_tree_high(:,1)==eta_2);
...
errorbar([0,2],mat_mean_SEM_tree_high([ind_1 ind_2],2),mat_mean_SEM_tree_high([ind_1 ind_2],3)*sqrt(200),'.','color','k', 'LineWidth',0.8);
...
addpath('../../export_fig/')
export_fig('Fig_mod12_high_eta.tif','-nocrop','-r200')
