...
errorbar([0,2],mat_mean_SEM_consistency([ind_1 ind_2],2),mat_mean_SEM_consistency([ind_1 ind_2],3)*sqrt(200),'.','color','k', 'LineWidth',0.8);
...
addpath('../../export_fig/')
export_fig('Fig_mod12_consist_eta.tif','-nocrop','-r200')
