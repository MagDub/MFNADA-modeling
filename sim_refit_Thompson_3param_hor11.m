function sim_refit_Thompson_3param_hor11(ID)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if holly == 1
        sim_dir = strcat('/home/mdubois/data/simulation_data/thompson/3params/', int2str(n_per_dim), 'perdim/hor11/');
    else
        sim_dir = strcat('D:\MaggiesFarm\modeling_28_02\simulation_data\thompson\3params\', int2str(n_per_dim), 'perdim\hor11\');
    end
    ...
    [params, user] = apple_params_for_mod_hor11(); % TODO -> add unused tree to the log
    ...
    if holly == 1
        results_dir = strcat('/home/mdubois/data/simulation_data/thompson/3params/', int2str(n_per_dim), 'perdim/hor11/results/');
    else
        results_dir = strcat('D:\MaggiesFarm\modeling_28_02\simulation_data\thompson\3params\', int2str(n_per_dim), 'perdim\hor11\results\');
    end
