...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    settings.desc = ['mod12'];    % description of model (settings, etc)
    ...
    if holly == 1
        sim_dir = strcat('/home/mdubois/data/simulation_data/mod12/', int2str(n_per_dim), 'perdim/');
    else
        sim_dir = strcat('D:\MaggiesFarm\modeling_28_02\simulation_data\mod12\', int2str(n_per_dim), 'perdim\');
    end

    %% load parameter values
    tmp = load([sim_dir 'inp_params_mod12.mat']);
    ...
    if holly == 1
        results_dir = strcat('/home/mdubois/data/simulation_data/mod12/', int2str(n_per_dim), 'perdim/results/');
    else
        results_dir = strcat('D:\MaggiesFarm\modeling_28_02\simulation_data\mod12\', int2str(n_per_dim), 'perdim\results\');
    end
    ...
    modelfun = @(x) modelMF_S0fixed_eta_thomp4param_MAP(x,settings.params.param_names,ID,settings,data,gameIDs);
