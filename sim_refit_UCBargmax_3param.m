function sim_refit_UCBargmax_3param(ID)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    settings.desc = ['sim_UCBargmax_' int2str(ID)];    % description of model (settings, etc)
    ...
    if holly == 1
        sim_dir = strcat('/home/mdubois/data/simulation_data/UCBargmax/3params/', int2str(n_per_dim), 'perdim/');
    else
        sim_dir = strcat('D:\MaggiesFarm\modeling_28_02\simulation_data\UCBargmax\3params\', int2str(n_per_dim), 'perdim\');
    end

    %% load parameter values
    tmp = load([sim_dir 'inp_params_UCBargmax.mat']);
    ...
    if holly == 1
        results_dir = strcat('/home/mdubois/data/simulation_data/UCBargmax/3params/', int2str(n_per_dim), 'perdim/results/');
    else
        results_dir = strcat('D:\MaggiesFarm\modeling_28_02\simulation_data\UCBargmax\3params\', int2str(n_per_dim), 'perdim\results\');
    end
