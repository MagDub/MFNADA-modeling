...
consistency_freq_simulation_mod8 = nan(60,2);

num_trials = 10*400;

for ID = 501:560
    
    load(strcat('D:\MaggiesFarm\modeling_28_02\simulation_data\simulated_data_from_fitted_params_mod8\num_trials_',int2str(num_trials),'\participant_',int2str(ID),'\data.mat'))
    ...
    consistency_freq_simulation_mod8(ID-500,:) = [consistency_freq_simulation_LH consistency_freq_simulation_SH];
end

consistency_freq_simulation_mod8_desc = {'LH_Consistent','SH_Consistent'};

save('D:\writing\MF\data_for_figs\consistency_freq_simulation_mod8.mat', 'consistency_freq_simulation_mod8');
save('D:\writing\MF\data_for_figs\consistency_freq_simulation_desc_mod8.mat', 'consistency_freq_simulation_mod8_desc');
