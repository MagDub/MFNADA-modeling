...
for i = 1:60
    ID = i+500;
    load(strcat('D:\MaggiesFarm\modeling_28_02\participant_data\hybrid\3params_xi_1Hor\results\fmincon\res_hybrid_',int2str(ID),'_results.mat'))
    mEmat(i) = mE;
end
...
%% save
save('participant_data/priors/hybrid_3params_xi/empirical_prior.mat','prior')
