...
for i = 1:60 %:60
    ID = i+500;
    load(strcat('D:\MaggiesFarm\modeling_28_02\participant_data\UCB\2params_1Hor\results\fmincon\res_UCB_',int2str(ID),'_results.mat'))
    mEmat(i) = mE;
end
...
%% save
save('participant_data/priors/UCB_2params/empirical_prior.mat','prior')
