function fit_mod12_like_param_recovery_2sgm0_prior1normal(ID)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    algo = 'thompson_like_param_recovery_2sgm0_prior1normal';
    
    if holly == 1
        results_dir = strcat('/home/mdubois/data/participant_data/',algo,'/results/');
    else
        results_dir = strcat('D:\MaggiesFarm\modeling_28_02\participant_data\thompson_model_fit\',algo,'\results\');
    end
