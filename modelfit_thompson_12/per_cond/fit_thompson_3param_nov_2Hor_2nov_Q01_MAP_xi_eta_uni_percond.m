function fit_thompson_3param_nov_2Hor_2nov_Q01_MAP_xi_eta_uni_percond(ID, optim_algo)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if holly == 1
        results_dir = strcat('/home/mdubois/data/participant_data/',algo,'/',int2str(n_param), 'params_2Hor_Q01_percond/results/', optim_algo,'/');
    else
        results_dir = strcat('D:\MaggiesFarm\modeling_28_02\participant_data\',algo,'\', int2str(n_param), 'params_2Hor_Q01_percond\results\',optim_algo,'\');
    end
    ...
    modelfun = @(x) modelMF_S0fixed_eta_thomp4param_MAP_xi_eta_uni(x,settings.params.param_names,ID,settings,data,gameIDs);
