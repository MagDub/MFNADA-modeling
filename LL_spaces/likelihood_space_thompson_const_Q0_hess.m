...
function likelihood_space_thompson_const_Q0_hess(ID)
%for ID = 501:502 % 560
    ...
    if holly ==0
        fmincon_data = load(strcat('D:\MaggiesFarm\modeling_28_02\participant_data\thompson\3params\results_Bounds1\fmincon\res_thompson_',int2str(ID),'_results.mat'));
    elseif holly == 1
    ...
    fmincon_data_sgm0 = fmincon_data.mEparams(1); %just the short one
    ...
    Q0_both=sort([fmincon_data_Q0 genetic_data_Q0]);

    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    param_bounds_xi = [0.01,0.8];
    param_bounds_sgm0 = [1,10]; 
    param_bounds_Q0 = Q0_both;
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    for i_sgm0=1:size(vec_sgm0,2)
        for i_xi=1:size(vec_xi,2)
            for i_Q0=1:size(vec_Q0,2)
                ...
                nlogLmat_cst_Q0(i_sgm0, i_xi, i_Q0) = nLogL;
                detHessmat_cst_Q0(i_sgm0, i_xi, i_Q0) = det(NumHessianY(modelfun,mEparams)); 
            end
        end
    end
    
    struct_cst_Q0.nlogLmat = nlogLmat_cst_Q0;
    struct_cst_Q0.param_bounds_xi = param_bounds_xi;
    struct_cst_Q0.param_bounds_Q0 = param_bounds_Q0;
    struct_cst_Q0.param_bounds_sgm0 = param_bounds_sgm0;
    struct_cst_Q0.n_per_dim = n_per_dim;
    struct_cst_Q0.fmincon_data_sgm0 = fmincon_data_sgm0;
    struct_cst_Q0.fmincon_data_Q0 = fmincon_data_Q0;
    struct_cst_Q0.fmincon_data_xi = fmincon_data_xi;
    struct_cst_Q0.detHessmat = detHessmat_cst_Q0;
    struct_cst_Q0.genetic_data_sgm0 = genetic_data_sgm0;
    struct_cst_Q0.genetic_data_Q0 = genetic_data_Q0;
    struct_cst_Q0.genetic_data_xi = genetic_data_xi;
       
    if holly == 0
        save(strcat('D:\MaggiesFarm\modeling_28_02\participant_data\LLsurfaces\thompson\participant_', int2str(ID), '_struct_cst_Q0.mat'),'-struct', 'struct_cst_Q0');
    elseif holly == 1
        save(strcat('/home/mdubois/data/participant_data/LLsurfaces/thompson/participant_', int2str(ID), '_struct_cst_Q0.mat'),'-struct', 'struct_cst_Q0');
    end
