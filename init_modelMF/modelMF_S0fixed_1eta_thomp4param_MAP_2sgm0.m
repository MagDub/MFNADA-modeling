function [nMAP, nLogL, mo, logL] = modelMF_S0fixed_1eta_thomp4param_MAP_2sgm0(param_val,param_names,sID,settings,data,gameIDs)
...
param_names = {'sgm0', 'sgm0', 'Q0','xi', 'xi', 'eta'};
