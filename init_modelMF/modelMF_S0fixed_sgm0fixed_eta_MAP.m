function [nMAP, nLogL, mo, logL] = modelMF_S0fixed_sgm0fixed_eta_MAP(param_val,param_names,sID,settings,data,gameIDs)
...
load('participant_data\priors\UCB_4params\empirical_prior.mat'); %from generate_empirical_priors.m
