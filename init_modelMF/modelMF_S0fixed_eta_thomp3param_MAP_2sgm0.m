function [nMAP, nLogL, mo, logL] = modelMF_S0fixed_eta_thomp3param_MAP_2sgm0(param_val,param_names,sID,settings,data,gameIDs)
...
if holly == 1
    load('\home\mdubois\data\participant_data\priors\thompson_3params\empirical_prior.mat'); %from generate_empirical_priors.mend
else
    load('participant_data\priors\thompson_3params_xi_eta_uni\empirical_prior.mat'); %from generate_empirical_priors.mend
end
