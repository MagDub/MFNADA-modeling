function [nMAP, nLogL, mo, logL] = modelMF_S0fixed_eta_thomp4param_MAP_2sgm0_holly(param_val,param_names,sID,settings,data,gameIDs)
...
if holly == 1
    load('/home/mdubois/data/participant_data/priors/thompson_4params_xi_eta_uni/empirical_prior.mat','prior'); %from generate_empirical_priors.mend
else
    load('participant_data/priors/thompson_4params_xi_eta_uni/empirical_prior.mat','prior') %from generate_empirical_priors.mend
end
