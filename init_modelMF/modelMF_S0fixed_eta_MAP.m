function [nMAP, nLogL, mo, logL] = modelMF_S0fixed_eta_MAP(param_val,param_names,sID,settings,data,gameIDs)
...
load('participant_data\priors\hybrid_7params\empirical_prior.mat'); %from generate_empirical_priors.m
