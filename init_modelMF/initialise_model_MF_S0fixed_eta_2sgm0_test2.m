function mo = initialise_model_MF_S0fixed_eta_2sgm0_test2(settings)
...
mo.params.sgm0           = nan(settings.task.N_games,1); % prior mean (set up, so that learning can be implemented
mo.params.sgm02          = []; % prior mean std (set up, so that learning can be implemented
