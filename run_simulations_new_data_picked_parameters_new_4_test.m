...
for s_i = 1:size(sgm0_mat,2)
    for q_i = 1:size(Q_0_mat,2)

        for i = 1%:10

            Q_0 = Q_0_mat(q_i);

            sgm0 = [sgm0_mat(s_i), sgm0_mat(s_i)];

            xi = [xi_range(i) 0.3+xi_range(i)];
        ...
        %     end
            ...
            mkdir(strcat('D:\writing\MF\data_for_figs\to_analyse5_test\',int2str(part_num),'pp_xi_0_0.3_sgm0_',num2str(sgm0(1)),'_q0_',num2str(Q_0(1)),'_eta_',num2str(eta(1)),'\sim_picked_parameters',int2str(n_try)))

            save(strcat('D:\writing\MF\data_for_figs\to_analyse5_test\',int2str(part_num),'pp_xi_0_0.3_sgm0_',num2str(sgm0(1)),'_q0_',num2str(Q_0(1)),'_eta_',num2str(eta(1)),'\sim_picked_parameters',int2str(n_try),'\para_vals.mat'), 'para_vals');
            save(strcat('D:\writing\MF\data_for_figs\to_analyse5_test\',int2str(part_num),'pp_xi_0_0.3_sgm0_',num2str(sgm0(1)),'_q0_',num2str(Q_0(1)),'_eta_',num2str(eta(1)),'\sim_picked_parameters',int2str(n_try),'\para_vals_desc.mat'), 'para_vals_desc');
            save(strcat('D:\writing\MF\data_for_figs\to_analyse5_test\',int2str(part_num),'pp_xi_0_0.3_sgm0_',num2str(sgm0(1)),'_q0_',num2str(Q_0(1)),'_eta_',num2str(eta(1)),'\sim_picked_parameters',int2str(n_try),'\sim_prob_choosing_trees_new_data.mat'), 'sim_prob_choosing_trees_new_data');
            save(strcat('D:\writing\MF\data_for_figs\to_analyse5_test\',int2str(part_num),'pp_xi_0_0.3_sgm0_',num2str(sgm0(1)),'_q0_',num2str(Q_0(1)),'_eta_',num2str(eta(1)),'\sim_picked_parameters',int2str(n_try),'\sim_prob_choosing_trees_new_data_desc.mat'), 'sim_prob_choosing_trees_new_data_desc');
