function sim_refit_hybrid_5param(ID)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if holly == 1
        sim_dir = strcat('/home/mdubois/data/simulation_data/hybrid/5params/', int2str(n_per_dim), 'perdim/');
    else
        sim_dir = strcat('D:\MaggiesFarm\modeling_28_02\simulation_data\hybrid\5params\', int2str(n_per_dim), 'perdim\');
    end
    ...
    if holly == 1
        results_dir = strcat('/home/mdubois/data/simulation_data/hybrid/5params/', int2str(n_per_dim), 'perdim/results/');
    else
        results_dir = strcat('D:\MaggiesFarm\modeling_28_02\simulation_data\hybrid\5params\', int2str(n_per_dim), 'perdim\results\');
    end
