function sim_refit_UCB_3param_hor6(ID)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if holly == 1
        sim_dir = strcat('/home/mdubois/data/simulation_data/UCB/3params/', int2str(n_per_dim), 'perdim/hor6/');
    else
        sim_dir = strcat('D:\MaggiesFarm\modeling_28_02\simulation_data\UCB\3params\', int2str(n_per_dim), 'perdim\hor6\');
    end
    ...
    if holly == 1
        results_dir = strcat('/home/mdubois/data/simulation_data/UCB/3params/', int2str(n_per_dim), 'perdim/hor6/results/');
    else
        results_dir = strcat('D:\MaggiesFarm\modeling_28_02\simulation_data\UCB\3params\', int2str(n_per_dim), 'perdim\hor6\results\');
    end
